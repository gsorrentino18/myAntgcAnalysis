...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
class EEbdtValidation{
public:
	EEbdtValidation(std::string FILELIST,
                           std::string OUTFILE,
                           Float_t XSECTION = -1.,
                           ...
                           std::string BDT_PATH = "/local/cms/user/wadud/aNTGCmet/aNTGC_analysis/phoIDstudy/UL17/BDT/training/tuning/v5/EE/aNTGC_photon_BDT_EE_2021_08_19_07_51_23.model");
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
EEbdtValidation::EEbdtValidation(std::string FILELIST, std::string OUTFILE, Float_t XSECTION, std::string MCPILEUPHIST, std::string DATAPILEUPHIST,
	...
	"Running EEbdtValidation"<<std::endl<<
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Short_t	EEbdtValidation::matchWithRecoPho(Short_t _genIndex, Float_t _deltaRmax, Float_t _relDeltaPtMin, Float_t _relDeltaPtMax){
...
Short_t EEbdtValidation::matchWithRecoEle(Short_t _genIndex, Float_t _deltaRmax, Float_t _relDeltaPtMin, Float_t _relDeltaPtMax){
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Short_t	EEbdtValidation::matchWithTrigPho(Short_t _phoIndex, Float_t _deltaRmax, Float_t _relDeltaPtMin, Float_t _relDeltaPtMax){
	Float_t minDeltaR = 999.;
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Bool_t EEbdtValidation::selectEvent(){
	//// reset event cut flow
	fullEE.lastCutStep = 0.;
	registerAllCutFlow();
        return 1;
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Bool_t EEbdtValidation::initEventTypes(){
	initEventType(fullEE, "tnpPhoIDs", "Full ECAL Barrel");
	return 1;
};
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if(isMC) {
			...
			if(doPUreweight){
				...
				Float_t genPUweight = genWeight_ * puWeight_;
                                //cout << "genweight: " << genWeight_ << "puweight: " << puWeight_ << endl; 
                                weight = genPUweight;
		  ...
		  if( ((_eleCalibPt[iEle] > 37) && (getBit(iID,4))) == false ) continue;
                  ...
                  for(UShort_t iPho=0; iPho<_nPho; iPho++){
                     ...
                     if ( fabs(_phoEta[iPho]) < BETRetaMax ) continue; //EE selection
               ...
               Float_t 	scE                    = _ecalSC_En[phoSCindex];
                  ...
                  if(predictBDT){
                     ...
                     pass95_ = (phoBDTpred_ > 0.6948 && phoHoverE_ < 0.0175 &&  phoPFECALClusIsoCorr_ < 2.94 && phoTkrIsoCorr_ < 1.90);
               ...
               if(foundPair) {
                  ...
                  Float_t phoS4_ = _phoE2x2Full5x5[probePhoton]/_ecalSC_RawEn[probePhoton];                  
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Bool_t EEbdtValidation::initNtuples(std::string FILELIST){
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void EEbdtValidation::initEventType(eventType & evType, std::string typeName, std::string typeTitle){
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void EEbdtValidation::fillEventType(eventType & evType){
	evType.tree->Fill();
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void EEbdtValidation::registerAllCutFlow(){
	registerCutFlow(fullEE);
};
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
void EEbdtValidation::registerCutFlow(eventType & evType){
