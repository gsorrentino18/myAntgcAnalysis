...
sampleSheet=/local/cms/user/gsorrent/antgc_analysis/samples/aNTGC_Samples-ntuples_2018UL.csv
jobListFile=/local/cms/user/gsorrent/antgc_analysis/BDTValidation/UL18/batch/jobList.txt
...
#className="EBbdtValidation"
#ccfilepath="/local/cms/user/gsorrent/antgc_analysis/BDTValidation/UL18/EBbdtValidation.cc"

className="EEbdtValidation"
ccfilepath="/local/cms/user/gsorrent/antgc_analysis/BDTValidation/UL18/EEbdtValidation.cc"

macroTemplate=${workDir}/macroTemplateV2.C
runScriptTemplate=${workDir}/run_script.sh
condorCFGtemplate=${workDir}/condor_job.sh

dataPUfile="/local/cms/user/wadud/aNTGCmet/aNTGC_analysis/data/pileupUL18/pileup_2018_data.root"
############################################################################
