...
sampleSheet=/local/cms/user/gsorrent/antgc_analysis/atgcStudies/ntuples_2017_METbugfix.csv
jobListFile=/local/cms/user/gsorrent/antgc_analysis/atgcStudies/batch/jobList.txt
...
className="atgcStudies"
ccfilepath="/local/cms/user/gsorrent/antgc_analysis/atgcStudies/atgcStudies.cc"
