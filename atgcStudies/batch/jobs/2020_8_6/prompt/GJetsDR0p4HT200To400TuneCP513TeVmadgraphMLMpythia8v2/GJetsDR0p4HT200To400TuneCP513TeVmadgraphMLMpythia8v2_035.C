#include "/local/cms/user/wadud/aNTGCmet/aNTGC_analysis/phoIDstudy/genPhoMatcher.cc"

void GJetsDR0p4HT200To400TuneCP513TeVmadgraphMLMpythia8v2_035(){
	std::cout<<getCurrentTime()<<std::endl;
	std::cout<<"Begin root macro..."<<std::endl;
	
	genPhoMatcher("/data/cmszfs1/user/wadud/aNTGCmet/aNTGC_analysis/phoIDstudy/batch/jobs/2020_8_6/prompt//GJetsDR0p4HT200To400TuneCP513TeVmadgraphMLMpythia8v2/GJetsDR0p4HT200To400TuneCP513TeVmadgraphMLMpythia8v2_035", 
				"/data/cmszfs1/user/wadud/aNTGCmet/aNTGC_analysis_skim/phoID/2020_08_06/prompt//GJetsDR0p4HT200To400TuneCP513TeVmadgraphMLMpythia8v2//GJetsDR0p4HT200To400TuneCP513TeVmadgraphMLMpythia8v2_035.root",
				1127,
